...
#endif
static void update_bms_status_flags();
static void print_bms_status_info();
...
static BMS_STATUS_FAULT0            bms_interrupt_fault0;
static BMS_STATUS_FAULT1            bms_interrupt_fault1;
...
void update_bms_status_flags()
{
    if ( ( chr_status0_reg.IINDPM_STAT == 1 ) || ( chr_flag0_reg.IINDPM_FLAG == 1 ) )
    {
        /*"IINDPM Regulation"*/
        bms_interrupt_flag.IINDPM_STAT = 1;
    }

    if ( ( chr_status0_reg.VINDPM_STAT == 1 ) || ( chr_flag0_reg.VINDPM_FLAG == 1 ) )
    {
        /*"VINDPM Regulation*/
        bms_interrupt_flag.VINDPM_STAT = 1;
    }

    if ( ( chr_status2_reg.TREG_STAT == 1 ) || ( chr_flag1_reg.TREG_FLAG == 1 ) )
    {
        bms_interrupt_flag.TREG_STAT =1;
        /*THERMAL Regulation*/
    }

    if ( ( chr_status2_reg.ICO_STAT == 1 ) || ( chr_flag1_reg.ICO_FLAG == 1 ) )
    {
        bms_interrupt_flag.ICO_FLAG = 1;    /*ICO Algo running*/
    }
    ...
    {
        /*VAC1 OVP*/
        bms_interrupt_fault0.VAC1_OVP_STAT = 1;
    ...
    {
        /*VAC2 OVP*/
        bms_interrupt_fault0.VAC2_OVP_STAT = 1; 
    }
    ...
    {
        /*CONV OCP*/
        bms_interrupt_fault0.CONV_OCP_STAT = 1;
    ...
    {
        /*IBAT OCP*/
        bms_interrupt_fault0.IBAT_OCP_STAT = 1;
    }
    ...
    {
        /*IBUS OCP*/
        bms_interrupt_fault0.IBUS_OCP_STAT = 1;
    }
    ...
    {
        /*VBAT OVP*/
        bms_interrupt_fault0.VBAT_OVP_STAT = 1;
    }
    ...
    {
        /*VBUS OVP*/
        bms_interrupt_fault0.VBUS_OVP_STAT = 1;
    }

    if ( ( IBAT_FAULT_STAT_DEV_IN_BAT_DISCHARG_CR   == fault_stat0_reg.IBAT_REG_STAT ) ||
        ( FAULT_FLAG0_IBAT_ENTER_OR_EXIT_REGULATION == fault_flag0_reg.IBAT_REG_FLAG ) )
    {
        /*IBAT DISCHARGE CURRENT REGULATION*/
        bms_interrupt_fault0.IBAT_REG_STAT = 1;
    }
    ...
    {
        /*THERMAL SHUTDOWN*/
        bms_interrupt_fault1.TSHUT_STAT = 1; 
    }

    if ( ( OTG_FAULT_STAT_DEV_OTG_UNDER_VOLTAGE           == fault_stat1_reg.OTG_UVP_STAT ) ||
            ( FAULT_FLAG1_STOP_OTG_DUE_TO_VBUS_UNDER_VOLTAGE == fault_flag1_reg.OTG_UVP_FLAG ) )
    {
        /*STOP OTG : VBUS UNDER VOLTAGE*/
        bms_interrupt_fault1.OTG_UVP_STAT = 1;
    }

    if ( ( OTG_FAULT_STAT_DEV_OTG_OVER_VOLTAGE            == fault_stat1_reg.OTG_OVP_STAT ) ||
            ( FAULT_FLAG1_STOP_OTG_DUE_TO_VBUS_UNDER_VOLTAGE == fault_flag1_reg.OTG_OVP_FLAG ) )
    {
        /*STOP OTG : VBUS OVER VOLTAGE*/
        bms_interrupt_fault1.OTG_OVP_STAT = 1;
    }
    ...
    {
        /*VSYS OVP*/;
        bms_interrupt_fault1.VSYS_OVP_STAT = 1;
    }
            ...
            ( FAULT_FLAG1_STOP_SWITCH_DUE_TO_SYS_SHORT              == fault_flag1_reg.VSYS_SHORT_FLAG ) )
    {
        ...
        bms_interrupt_fault1.VSYS_SHORT_STAT = 1;
    }
}

void print_bms_status_info()
{

    if(bms_interrupt_flag.IINDPM_STAT == 1)
    {
        bms_interrupt_flag.IINDPM_STAT = 0;
        LOG(W, "IINDPM Regulation");
    }

    if(bms_interrupt_flag.VINDPM_STAT == 1)
    {
        bms_interrupt_flag.VINDPM_STAT = 0;
        LOG(W, "VINDPM Regulation");
    }

    if ( bms_interrupt_flag.TREG_STAT == 1 )
    {
        bms_interrupt_flag.TREG_STAT = 0;
        LOG(E, "THERMAL Regulation");
    }
